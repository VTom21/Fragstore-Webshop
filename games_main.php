...
<body ng-controller="GameController">
    ...
    <div class="navbar" id="#top">
        ...
        <div id="cartSidebar" class="cart-sidebar"ng-class="{'active': cartOpen}">
            <div class="cart-header">
                <h2>Your Cart</h2>
                <button class="close-btn" onclick="closeCart()"ng-class="{'active': cartOpen}" ng-click="cartOpen = false">×</button>
            </div>
        ...
        <div id="cartOverlay" class="overlay" onclick="closeCart()"ng-class="{'active': cartOpen}" ng-click="cartOpen = false"></div>
        ...
        <div class="card" ng-repeat="game in filteredGames | filter:{name: searchText} | limitTo:itemsPerPage:((currentPage - 1) * itemsPerPage)">
            ...
            <div class="price-wrapper">
                ...
                <div class="btns">
                    ...
                    <button class="shop_btn"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
